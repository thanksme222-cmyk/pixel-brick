...
function SceneObject({ shape, color, textureUrl, scale, rotationSpeed }: any) {
  ...
  // ✅ FIXED: Using MeshStandardMaterialParameters instead of MeshStandardMaterialProps
  const materialProps: THREE.MeshStandardMaterialParameters = {
    ...
    roughness: 0.1, // Slightly glossier for a "plastic brick" look
    metalness: 0.2,
  };
  ...
  return (
    <div className="h-full w-full min-h-[500px] bg-white">
      ...
      >
        ...
        <spotLight position={[-5, 8, 5]} angle={0.3} intensity={brightness} castShadow />
